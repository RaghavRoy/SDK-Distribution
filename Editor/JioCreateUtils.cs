...
namespace UnityEditor.JioXR.Interaction.Toolkit
{
    static class JioCreateUtils
    {
...
#pragma warning restore IDE0051
        ...
        [MenuItem("GameObject/JioXR/XR Origin (VR)", false, 10), UsedImplicitly]
        ...
        [MenuItem("GameObject/JioXR/Device-based/XR Origin (VR)", false, 10), UsedImplicitly]
         ...
         static GameObject CreateXROriginWithParent(Transform parent, HardwareTarget target, InputType inputType)
        {
            ...
            var xrCamera = Camera.main; // XRMainCameraFactory.CreateXRMainCamera(target, inputType);
