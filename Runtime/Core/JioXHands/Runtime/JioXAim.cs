...
namespace UnityEngine.XR.Hands
{
    ...
    /// <see cref="JioXAimHand.aimFlags"/> and casting to this type.
    /// </summary>
    [Flags]
    [Preserve]
    public enum JioXAimFlags : ulong
    {
        /// <summary>
        /// No flags are valid.
        /// </summary>
        ...
        /// <see cref="JioXAimHand.pinchStrengthIndex"/> is
        ...
        /// Only valid when the pinch strength retrieved from
        /// <see cref="JioXAimHand.pinchStrengthMiddle"/> is
        /// at a full strength of <c>1.0</c>.
        /// </summary>
        MiddlePinching = 1 << 3,
        ...
        /// Only valid when the pinch strength retrieved from
        /// <see cref="JioXAimHand.pinchStrengthRing"/> is
        /// at a full strength of <c>1.0</c>.
        /// </summary>
        RingPinching = 1 << 4,
        ...
        /// Only valid when the pinch strength retrieved from
        /// <see cref="JioXAimHand.pinchStrengthLittle"/> is
        /// at a full strength of <c>1.0</c>.
        /// </summary>
        LittlePinching = 1 << 5,
...
#endif
    [Preserve, InputControlLayout(displayName = "JioX Hand", commonUsages = new[] { "LeftHand", "RightHand" })]
    public partial class JioXAimHand : TrackedDevice
    {
        /// <summary>
        ...
        /// plug-in.
        /// </remarks>
        public static JioXAimHand left { get; set; }
        ...
        /// plug-in.
        /// </remarks>
        public static JioXAimHand right { get; set; }
        ...
        [Preserve, InputControl]
        public Vector3Control pinchPostion { get; private set; }

        [Preserve, InputControl]
        public QuaternionControl pinchRotation { get; private set; }

        [Preserve, InputControl]
        public Vector3Control pokePostion { get; private set; }
        ...
        protected override void FinishSetup()
        {
            ...
            pinchPostion = GetChildControl<Vector3Control>(nameof(pinchPostion));
            pinchRotation = GetChildControl<QuaternionControl>(nameof(pinchRotation));
            pokePostion = GetChildControl<Vector3Control>(nameof(pokePostion));
        ...
        /// plug-in.
        /// </remarks>
        public static JioXAimHand CreateHand(InputDeviceCharacteristics extraCharacteristics)
        {
            var desc = new InputDeviceDescription
            {
                product = k_JioXAimHandDeviceProductName,
                manufacturer = k_JioXAimHandDeviceManufacturerName,
            ...
            return InputSystem.InputSystem.AddDevice(desc) as JioXAimHand;
        }
            ...
            Pose pinchPose)
        {
            ...
            if ((aimFlags & JioXAimFlags.Computed) == JioXAimFlags.None)
            {
                if (m_WasTracked)
                {
            ...
            if (isHandRootTracked)
            {
                ...
                InputSystem.InputSystem.QueueDeltaStateEvent(devicePosition, pokePose.position);
                InputSystem.InputSystem.QueueDeltaStateEvent(deviceRotation, pokePose.rotation);

                InputSystem.InputSystem.QueueDeltaStateEvent(devicePosition, pinchPose.position);
                InputSystem.InputSystem.QueueDeltaStateEvent(deviceRotation, pinchPose.rotation);
        ...
        internal void UpdateHand(bool isLeft, bool isHandRootTracked)
        {
            ...
            out Vector3 pokePositon,
            out Quaternion pokeRotation,
            out Vector3 pinchPosition,
            out Quaternion pinchRotation);
            ...
            UpdateHand(
                ...
                pinchRing,
                pinchLittle,
                new Pose(pokePositon, pokeRotation),
                new Pose(pinchPosition, pinchRotation));
...
#if UNITY_EDITOR
        static JioXAimHand() => RegisterLayout();
#endif
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)]
        static void RegisterLayout()
        {
            InputSystem.InputSystem.RegisterLayout<JioXAimHand>(
                    matches: new InputDeviceMatcher()
                    .WithProduct(k_JioXAimHandDeviceProductName)
                    .WithManufacturer(k_JioXAimHandDeviceManufacturerName));
        }

        const string k_JioXAimHandDeviceProductName = "JioX Hand Tracking";
        const string k_JioXAimHandDeviceManufacturerName = "Jio";

        JioXAimFlags m_PreviousFlags;
        bool m_WasTracked;
    ...
    //Poke Position , Poke Rotation, pinch position, pinch rotaion
}
