...
namespace UnityEngine.XR.Hands
{
    ...
    /// </remarks>
    public struct JioXHand : IEquatable<JioXHand>
    {
        /// <summary>
        ...
        /// <see cref="JioXHand"/> and it compares equal to this one using
        /// <see cref="Equals(UnityEngine.XR.Hands.JioXHand)"/>.
        /// </returns>
        public override bool Equals(object obj) => obj is JioXHand other && Equals(other);
        ...
        /// <summary>
        /// Tests for equality. Same as <see cref="Equals(UnityEngine.XR.Hands.JioXHand)"/>.
        /// </summary>
        /// <param name="lhs">The left-hand side of the comparison.</param>
        /// <param name="rhs">The right-hand side of the comparison.</param>
        /// <returns>Returns the same value as <see cref="Equals(UnityEngine.XR.Hands.JioXHand)"/>.</returns>
        public static bool operator ==(JioXHand lhs, JioXHand rhs) => lhs.Equals(rhs);

        /// <summary>
        /// Tests for inequality. Same as !<see cref="Equals(UnityEngine.XR.Hands.JioXHand)"/>
        /// </summary>
        /// <param name="lhs">The left-hand side of the comparison.</param>
        /// <param name="rhs">The right-hand side of the comparison.</param>
        /// <returns>Returns the negation of <see cref="Equals(UnityEngine.XR.Hands.JioXHand)"/>.</returns>
        public static bool operator !=(JioXHand lhs, JioXHand rhs) => !lhs.Equals(rhs);

        internal JioXHand(Handedness handedness, Allocator allocator)
        {
