...
namespace UnityEngine.XR.Hands
{
    ...
    /// </remarks>
    public partial class JioXHandSubsystem
        : SubsystemWithProvider<XRHandSubsystem, XRHandSubsystemDescriptor, XRHandSubsystemProvider>
    {
        ...
        /// </remarks>
        public JioXHand leftHand => m_LeftHand;
        JioXHand m_LeftHand;

        internal unsafe void SetLeftHand(JioXHand hand)
        {
        ...
        /// available hand tracking data.
        /// </remarks>
        public JioXHand rightHand => m_RightHand;
        JioXHand m_RightHand;

        internal unsafe void SetRightHand(JioXHand hand)
        {
        ...
        /// </remarks>
        public Action<JioXHandSubsystem, UpdateSuccessFlags, UpdateType> updatedHands;
        ...
        /// </remarks>
        public Action<JioXHand> trackingAcquired;
        ...
        /// </remarks>
        public Action<JioXHand> trackingLost;
...
/*        public void RegisterProcessor<TProcessor>(TProcessor processor)
        ...
        protected override void OnCreate()
        {
            ...
            m_LeftHand = new JioXHand(Handedness.Left, Allocator.Persistent);
            m_RightHand = new JioXHand(Handedness.Right, Allocator.Persistent);
